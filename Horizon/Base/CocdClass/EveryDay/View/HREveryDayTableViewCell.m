...
@implementation HREveryDayTableViewCell
...
- (void)setModel:(HREveryDayModel *)model{
    ...
    if (_model != model) {
        ...
        NSString *timeString = [NSString stringWithFormat:@"%02ld'%02ld''",time/60,time% 60];//显示的是视频的总时间
