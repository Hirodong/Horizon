...
//        _collectionCustom = [[HRCustomView alloc]initWithFrame:CGRectMake(5, y, (kWidth - 10) / 4, 30) Width:width LabelString:model.collectionCount collor:collor];
//        [self addSubview:_collectionCustom];
//
//        _shareCustom = [[HRCustomView alloc]initWithFrame:CGRectMake((kWidth - 10) / 4 + 5, y, (kWidth - 10) / 4, 30) Width:width LabelString:model.shareCount collor:collor];
//        [self addSubview:_shareCustom];
//        _cacheCustom = [[HRCustomView alloc]initWithFrame:CGRectMake(_shareCustom.frame.origin.x + _shareCustom.frame.size.width, y, (kWidth - 10) / 4, 30) Width:width LabelString:@"缓存" collor:collor];
//        [self addSubview:_cacheCustom];
//        _replyCustom = [[HRCustomView alloc]initWithFrame:CGRectMake(_cacheCustom.frame.origin.x + _cacheCustom.frame.size.width, y, (kWidth - 10) / 4, 30) Width:width LabelString:model.replyCount collor:collor];
